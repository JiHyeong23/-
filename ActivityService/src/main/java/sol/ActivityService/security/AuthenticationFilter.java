...
import sol.ActivityService.user.UserService;
import sol.ActivityService.user.dto.UserLoginDto;
import sol.ActivityService.util.Result;
import sol.ActivityService.validation.ApiException;
...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain, Authentication authResult)
        ...
        sol.ActivityService.user.User user = userService.findByEmail(username);
